...
const IMAGES = {
  amber: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?auto=format&fit=crop&w=1200&q=70",
  warm: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?auto=format&fit=crop&w=1200&q=70",
  cool: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1200&q=70",
  dust: "https://images.unsplash.com/photo-1504307651254-35680f356dfd?auto=format&fit=crop&w=1200&q=70",
  steel: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?auto=format&fit=crop&w=1200&q=70",
  breeze: "https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?auto=format&fit=crop&w=1200&q=70"
};
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxDEV("header", { className: `sticky top-0 z-50 transition-all duration-300 ${scrolled ? "bg-white/90 backdrop-blur-lg shadow-soft" : "bg-white/50 backdrop-blur-sm"}`, children: [
      /* @__PURE__ */ jsxDEV("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxDEV("a", { href: "#top", onClick: (e) => smooth(e, "#top"), className: "flex items-center group", children: /* @__PURE__ */ jsxDEV("img", { src: "logo.svg", alt: "J\u0141 BUD", className: "h-10 w-auto" }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 343,
          columnNumber: 13
        }, this) }, void 0, false, {
                ...
                children: /* @__PURE__ */ jsxDEV("div", { className: "px-6 pb-6 pt-1", children: [
                  ...
                  /* @__PURE__ */ jsxDEV(
                    "a",
                    {
                      ...
                      onClick: (e) => {
                        e.preventDefault();
                        window.dispatchEvent(new CustomEvent("select-service", { detail: { option: s.option } }));
...
function Contact() {
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      if (opt) setWorkType(opt);
    };
    window.addEventListener("select-service", handler);
    return () => window.removeEventListener("select-service", handler);
  }, []);
  const fields = [
    { name: "Imi\u0119", key: "name", type: "text", placeholder: "Jan Kowalski", required: true },
    { name: "Telefon", key: "phone", type: "tel", placeholder: "500 000 000", required: true },
    { name: "Email", key: "email", type: "email", placeholder: "jan@przyklad.pl", required: true }
  ];
  return /* @__PURE__ */ jsxDEV("section", { id: "kontakt", className: "py-20 lg:py-28 bg-white", children: /* @__PURE__ */ jsxDEV("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12", children: [
    ...
    /* @__PURE__ */ jsxDEV(FadeUp, { delay: 0.1, children: /* @__PURE__ */ jsxDEV("div", { className: "bg-mist border border-line rounded-3xl p-6 sm:p-8 shadow-soft relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxDEV("h3", { className: "text-xl font-bold text-ink", children: "Popro\u015B o darmow\u0105 wycen\u0119" }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 973,
        columnNumber: 13
      }, this),
      /* @__PURE__ */ jsxDEV("p", { className: "text-sm text-slate-500 mt-1 mb-6", children: "Odezwiemy si\u0119 w ci\u0105gu 24 godzin roboczych." }, void 0, false, {
        fileName: "<stdin>",
        lineNumber: 974,
        columnNumber: 13
      }, this),
      sent ? /* @__PURE__ */ jsxDEV(
        motion.div,
        {
          initial: { opacity: 0, scale: 0.95 },
          animate: { opacity: 1, scale: 1 },
          className: "bg-white border border-emerald-200 rounded-2xl p-8 text-center",
          children: [
            /* @__PURE__ */ jsxDEV("span", { className: "inline-grid place-items-center w-14 h-14 rounded-full bg-emerald-100 text-emerald-600", children: /* @__PURE__ */ jsxDEV(Check, { className: "w-7 h-7" }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 980,
              columnNumber: 19
            }, this) }, void 0, false, {
            ...
            /* @__PURE__ */ jsxDEV("h4", { className: "mt-4 text-lg font-bold text-ink", children: "Dzi\u0119kujemy!" }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 982,
              columnNumber: 17
            }, this),
            /* @__PURE__ */ jsxDEV("p", { className: "mt-1 text-sm text-slate-500", children: "Twoje zapytanie zosta\u0142o wys\u0142ane. Skontaktujemy si\u0119 z Tob\u0105 wkr\xF3tce." }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 983,
              columnNumber: 17
            }, this),
            /* @__PURE__ */ jsxDEV("button", { onClick: () => {
              setSent(false);
              setWorkType("");
            }, className: "mt-5 text-sm font-semibold text-accent-deep hover:text-accent transition-colors", children: "Wy\u015Blij kolejne zapytanie" }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 984,
              columnNumber: 17
            }, this)
        ...
        this
      ) : /* @__PURE__ */ jsxDEV("form", { onSubmit: submit, className: "space-y-4 relative", children: [
        /* @__PURE__ */ jsxDEV("div", { className: "grid sm:grid-cols-2 gap-4", children: fields.map((f) => /* @__PURE__ */ jsxDEV("div", { children: [
          /* @__PURE__ */ jsxDEV("label", { className: "block text-sm font-medium text-slate-700 mb-1.5", children: [
            f.name,
            " ",
            /* @__PURE__ */ jsxDEV("span", { className: "text-accent-deep", children: "*" }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 993,
              columnNumber: 99
            }, this)
          ...
          /* @__PURE__ */ jsxDEV(
            "input",
            {
              ...
              className: "w-full bg-white border border-line rounded-xl px-4 py-3 text-sm text-ink placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all"
            },
            void 0,
            false,
            {
          ...
          /* @__PURE__ */ jsxDEV("div", { className: "relative", children: [
            /* @__PURE__ */ jsxDEV(
              "select",
              {
                ...
                className: "w-full bg-white border border-line rounded-xl px-4 py-3 text-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all appearance-none",
                children: [
                  /* @__PURE__ */ jsxDEV("option", { value: "", disabled: true, children: "Wybierz zakres prac" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1004,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDEV("option", { children: "Elewacje i termoizolacja" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1005,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDEV("option", { children: "Prace wyko\u0144czeniowe" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1006,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDEV("option", { children: "Stan surowy / konstrukcje stalowe" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1007,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDEV("option", { children: "Prace towarzysz\u0105ce i dachowe" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1008,
                    columnNumber: 23
                  }, this),
                  /* @__PURE__ */ jsxDEV("option", { children: "Inne / nie wiem" }, void 0, false, {
                    fileName: "<stdin>",
                    lineNumber: 1009,
                    columnNumber: 23
                  }, this)
            ...
            /* @__PURE__ */ jsxDEV(ChevronDown, { className: "w-4 h-4 text-slate-400 absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" }, void 0, false, {
              fileName: "<stdin>",
              lineNumber: 1011,
              columnNumber: 21
            }, this)
        ...
        /* @__PURE__ */ jsxDEV("div", { children: [
          /* @__PURE__ */ jsxDEV("label", { className: "block text-sm font-medium text-slate-700 mb-1.5", children: "Wiadomo\u015B\u0107" }, void 0, false, {
            fileName: "<stdin>",
            lineNumber: 1015,
            columnNumber: 19
          }, this),
          /* @__PURE__ */ jsxDEV(
            ...
            {
              rows: 3,
              placeholder: "Opisz kr\xF3tko swoje zadanie...",
              className: "w-full bg-white border border-line rounded-xl px-4 py-3 text-sm text-ink placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-accent/50 focus:border-accent transition-all resize-none"
            },
            void 0,
            false,
            {
        ...
        /* @__PURE__ */ jsxDEV(
          ...
          {
            type: "submit",
            className: "group w-full inline-flex items-center justify-center gap-2 bg-ink hover:bg-slate-800 text-white text-sm font-semibold px-6 py-4 rounded-xl shadow-soft hover:shadow-lift hover:-translate-y-0.5 transition-all",
            children: [
              "Wy\u015Blij zapytanie ",
              /* @__PURE__ */ jsxDEV(Send, { className: "w-4 h-4 group-hover:translate-x-1 transition-transform" }, void 0, false, {
                fileName: "<stdin>",
                lineNumber: 1021,
                columnNumber: 36
              }, this)
        ...
        /* @__PURE__ */ jsxDEV("p", { className: "text-xs text-slate-400 text-center", children: "Wysy\u0142aj\u0105c formularz akceptujesz nasze warunki. Dane s\u0105 przetwarzane wy\u0142\u0105cznie na potrzeby wyceny." }, void 0, false, {
          fileName: "<stdin>",
          lineNumber: 1023,
          columnNumber: 17
        }, this)
